      ...
      <header className="flex-1 mt-12">
        <div className="grid grid-cols-4  mx-4 py-8 text-center ">
          <div className="col-span-3  items-start flex ">
            <div className="flex flex-col justify-center items-start dark:text-slate-50 ">
              <h1>Nur hidayat</h1>
              <div className="flex justify-center items-center py-1">
                ...
                <span className="font-normal tracking-normal ms-2 dark:text-slate-300 cursor-default">
                  available for work
                </span>
              </div>
            </div>
