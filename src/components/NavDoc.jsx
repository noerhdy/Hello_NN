...
const NavDoc = () => {
  ...
  const getSpanClassName = (index) => {
    ...
    return "text-xs absolute  -ml-5 -top-8 opacity-0  items-start ";
  };
  ...
  return (
    <div className="fixed inset-x-0 bottom-0 flex h-16 mb-2 items-center ">
      <div className="mx-auto relative flex h-[64px] items-end gap-4 md:gap-2 rounded-2xl backdrop-blur-sm backdrop-filter border border-neutral-800/5 bg-gradient-to-t from-zinc-950/5 dark:bg-gradient-to-t dark:from-neutral-100/5 from-5%  px-6 pb-2 dark:bg-zinc-900/5 md:px4 ">
